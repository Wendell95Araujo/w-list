...
import com.example.wlist.ui.recyclerview.adapter.ListItem
import com.example.wlist.ui.recyclerview.adapter.ShoppingListAdapter
...
class ShoppingListActivity : AppCompatActivity(), ShoppingListAdapter.OnTotalAmountChangeListener {
    ...
    private val formLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
        if (result.resultCode == RESULT_OK) {
            ...
            val actionType = result.data?.getStringExtra(ShoppingItemFormActivity.EXTRA_ACTION_TYPE)

            when (actionType) {
                "ADDED" -> Toast.makeText(this, getString(R.string.toast_item_saved), Toast.LENGTH_SHORT).show()
                "EDITED" -> Toast.makeText(this, getString(R.string.toast_item_edited), Toast.LENGTH_SHORT).show()
                "DELETED" -> Toast.makeText(this, getString(R.string.toast_item_removed), Toast.LENGTH_SHORT).show()
            }
        }
    }
